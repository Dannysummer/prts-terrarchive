...
The complete corpus datasets are not included in this Git repository or in the npm package. Users may explicitly download them from ModelScope through the plugin's data manager:
